...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for gradle (com.github.bumptech.glide:glide)
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Creates a dependency provider for gradleKapt (com.github.bumptech.glide:compiler)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGradleKapt() {
            return create("gradleKapt");
    }
        ...
        /**
         * Creates a dependency provider for pagingData (androidx.paging:paging-runtime-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPagingData() {
            return create("pagingData");
    }
        ...
        /**
         * Creates a dependency provider for retrofitConverter (com.squareup.retrofit2:converter-gson)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRetrofitConverter() {
            return create("retrofitConverter");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: gradle (4.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: pagingData (3.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPagingData() { return getVersion("pagingData"); }
